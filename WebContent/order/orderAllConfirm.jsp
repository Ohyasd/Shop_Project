...
<input type="hidden" name="num" value="<%=num %>"><!-- cart번호 -->
	...
	<tr>
		<td>
			<table width="100%" cellspacing="0" cellpadding="0" border="1"
				...
				<tr>
					<td width="125" height="35" class="td_default">
						<input type="radio" id="payMethod" name="payMethod" value="신용카드" checked>신용카드</input>
						
						<input type="radio" id="payMethod" name="payMethod" value="계좌이체">계좌이체</input>
						
						<input type="radio" id="payMethod" name="payMethod" value="무통장 입금">무통장 입금</input>
					</td>
