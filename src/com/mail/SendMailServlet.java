...
public class SendMailServlet extends HttpServlet {
	...
	System.out.println(mailTo+"\t"+userid);
		String host = "smtp.naver.com"; //네이버메일사용 발송시
	    String subject = "백엔드과정에서 보내는 아이디확인메일입니다."; //제목
	    String from = "ohyasd@naver.com"; //보내는 사람의 메일주소
	   String fromName = "Test";
	    String to = "ohyasd@naver.com"; //받는사람의 메일
	    String content = "백엔드과정에서 보내는 아이디확인메일입니다. 귀하의 아이디:" + userid;//메일 내용
